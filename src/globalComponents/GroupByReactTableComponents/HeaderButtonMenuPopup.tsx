                ...
                <div className="tbl-headings justify-content-between" style={{ background: 'white', borderBottom: "none" }}>
                    <div className="">
                        ...
                        {items?.showEmailIcon === true ? <>
                            <div className="col-sm-12 p-0">
                                <div className="alignCenter mb-1"> <a className="teamIcon p-0 me-1" onClick={() => items?.openCreationAllStructure("sendEmail")}><span title="send email" style={{ color: `${portfolioColor}`, backgroundColor: `${portfolioColor}` }} className="svg__iconbox svg__icon--mail"></span></a>Send Email</div>
                            </div>
                        </> : ''}
