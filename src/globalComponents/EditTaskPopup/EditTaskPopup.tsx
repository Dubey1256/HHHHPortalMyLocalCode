    ...
    const UpdateTaskInfoFunction = async (typeFunction: any) => {
        ...
        try {
            ...
            await web.lists.getById(Items.Items.listId).items.getById(Items.Items.Id).update(UpdateDataObject).then((res: any) => {
                ...
                if (typeFunction != "TimeSheetPopup" &&(Items?.pageName!='TaskDashBoard'&&Items?.pageName!="ProjectProfile")) {
                    Items.Call();
                }
                if(Items?.pageName=='TaskDashBoard'||Items?.pageName=="ProjectProfile"){
