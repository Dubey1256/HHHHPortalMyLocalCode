...
const EditTaskPopup = (Items: any) => {
  ...
  const [ProjectManagementPopup, setProjectManagementPopup] =
  ...
  const [SmartLightPercentStatus, setSmartLightPercentStatus] =
    React.useState(false);
  const [ShowTaskDetailsStatus, setShowTaskDetailsStatus] =
    React.useState(false);
  ...
  const Call = React.useCallback((PopupItemData: any, type: any) => {
    ...
    if (type == "SmartComponent") {
      if (PopupItemData?.smartComponent?.length > 0) {
        ...
        console.log(
          "Popup component smartComponent ",
          PopupItemData.smartComponent
        );
      }
    }
    if (type == "Category") {
      if (
        PopupItemData?.categories != "" &&
        PopupItemData?.categories != undefined
      ) {
        Items.Items.Categories = PopupItemData.categories;
        let category: any = tempCategoryData
          ? tempCategoryData + ";" + PopupItemData.categories[0]?.Title
          : PopupItemData.categories[0]?.Title;
    ...
    if (type == "LinkedServices") {
      if (PopupItemData?.linkedComponent?.length > 0) {
        ...
        console.log(
          "Popup component linkedComponent",
          PopupItemData.linkedComponent
        );
      }
    }
  }, []);
  ...
  const getCurrentUserDetails = async () => {
    ...
    await pnp.sp.web.currentUser.get().then((result) => {
  ...
  const loadTaskUsers = async () => {
    ...
    axios
      .get(
        `${siteUrls}/_api/web/lists/getbyid('${AllListIdData?.TaskUsertListID}')/items?$select=Id,UserGroupId,TimeCategory,Suffix,Title,Email,SortOrder,Role,IsShowTeamLeader,Company,ParentID1,Status,Item_x0020_Cover,AssingedToUserId,isDeleted,AssingedToUser/Title,AssingedToUser/Id,AssingedToUser/EMail,ItemType,Approver/Id,Approver/Title,Approver/Name&$expand=AssingedToUser,Approver&$orderby=SortOrder asc,Title asc`
      )
      .then(
          ...
          $.each(taskUsers, function (index: any, user: any) {
            ...
            if (user.Title != undefined && user.IsShowTeamLeader === true) {
              if (user.Approver != undefined) {
                $.each(
                  user.Approver.results,
                  function (ApproverUser: any, index) {
                    ApproverUserItem +=
                      ApproverUser.Title +
    ...
    try {
      ...
      if (Items.Items.listId != undefined) {
        extraLookupColumnData = await web.lists
          ...
          .items.select(
            "Project/Id, Project/Title, AttachmentFiles/Title, Approver/Id, Approver/Title, ClientCategory/Id,ClientCategory/Title"
          )
          .top(5000)
        ...
        extraLookupColumnData = await web.lists
          ...
          .items.select(
            "Project/Id, Project/Title,AttachmentFiles/Title, Approver/Id, Approver/Title, ClientCategory/Title"
          )
          .top(5000)
          .filter(`Id eq ${Items.Items.Id}`)
          .expand("Project, Approver, ClientCategory")
    ...
    try {
      ...
      smartMeta?.map((item: any) => {
        ...
        setTaskResponsibleTeam(
          item.Responsible_x0020_Team ? item.Responsible_x0020_Team : []
        );
        ...
        if (TeamMemberTemp != undefined && TeamMemberTemp.length > 0) {
          ...
          setTaskTeamMembers(
            item.Team_x0020_Members ? item.Team_x0020_Members : []
          );
        }
        ...
        if (
          item.SharewebCategories != undefined &&
          item.SharewebCategories?.length > 0
        ) {
          let tempArray: any = [];
  ...
  const closeTaskStatusUpdatePopup = () => {
    ...
    setUpdateTaskInfo({
      ...UpdateTaskInfo,
      PercentCompleteStatus: EditData.PercentComplete
  ...
  const shareThisTaskFunction = (EmailData: any) => {
    var link =
      ...
      EmailData.Title +
      "&body=" +
      `${siteUrls}/SitePages/Task-Profile-spfx.aspx?taskId=${EmailData.ID}` +
      "&" +
      `Site=${Items.Items.siteType}`;
  ...
  const onRenderCustomReplaceImageHeader = () => {
    return (
      ...
      >
        ...
        >
          <span className="siteColor">Replace Image</span>
        </div>
        <Tooltip ComponentId="1683" />
      </div>
    );
  ...
  const onRenderCustomProjectManagementHeader = () => {
    return (
      ...
      >
        ...
        >
          <span className="siteColor">Select Project</span>
        </div>
        <Tooltip ComponentId="1683" />
      </div>
    );
  ...
  const onRenderCustomApproverHeader = () => {
    return (
      ...
      >
        ...
        >
          <span className="siteColor">Select Approver</span>
        </div>
        <Tooltip ComponentId="1683" />
      </div>
    );
          ...
          <div>
            ...
            <div>
              <a className="hreflink">
                ...
                {/* <RiDeleteBin6Line /> */}
                <span onClick={() => deleteTaskFunction(EditData.ID)}>
                  Delete This Item
                </span>
              </a>
              <span> | </span>
  ...
  const customFooterForProjectManagement = () => {
    return (
      <footer
        className={
          ServicesTaskCheck
            ? "serviepannelgreena text-end me-4"
            : "text-end me-4"
        }
      >
    ...
    <div className={ServicesTaskCheck ? "serviepannelgreena" : ""}>
        ...
        <div className={ServicesTaskCheck ? "serviepannelgreena" : ""}>
          ...
          <footer className="float-end">
            <button
              type="button"
              className="btn btn-primary px-3"
              onClick={() => setTaskStatusPopup(false)}
            >
              OK
            </button>
          </footer>
                    ...
                    <div className="mx-0 row mt-2">
                      <div className="col ps-0">
                        <div className="input-group mb-2">
                          <label className="full-width">
                            <span className="form-check form-check-inline mb-0 l-radio">
                              <input
                                ...
                                id="Components"
                                name="Portfolios"
                                checked={ComponentTaskCheck}
                                onClick={(e) =>
                                  ChangeComponentStatus(e, "Component")
                                }
                                title="Component"
                                className="form-check-input"
                              />
                            ...
                            <span className="form-check form-check-inline mb-0 l-radio">
                              <input
                                ...
                                onClick={(e) =>
                                  ChangeComponentStatus(e, "Service")
                                }
                                className="form-check-input"
                              />
                              <label className="form-check-label mb-0">
                          ...
                          {smartComponentData.length > 0 && ComponentTaskCheck
                            ? smartComponentData?.map((com: any) => {
                              return (
                                <>
                                  <div
                                    className="d-flex justify-content-between block px-2 py-1"
                                    style={{ width: "85%" }}
                                  >
                                    <a
                                      ...
                                      target="_blank"
                                      data-interception="off"
                                      href={`${Items.Items.siteType}/SitePages/Portfolio-Profile.aspx?taskId=${com.ID}`}
                                    >
                                      {com.Title}
                                    </a>
                                    <a>
                            ...
                            : null}
                          {smartServicesData?.length > 0 && ServicesTaskCheck
                            ? smartServicesData?.map((com: any) => {
                              return (
                                <>
                                  <div
                          ...
                          <span className="input-group-text">
                            ...
                            {ServicesTaskCheck ? (
                              <span
                                title="Service Popup"
                                onClick={(e) =>
                                  EditLinkedServices(EditData, "Services")
                                }
                                className="svg__iconbox svg__icon--editBox"
                              ></span>
                              ...
                              null}
                            {ComponentTaskCheck == false &&
                              ServicesTaskCheck == false ? (
                              <span
                                title="Component/Service Popup"
                                onClick={(e) =>
                                  alert(
                                    "Please select anyone from Portfolio/Services"
                                  )
                                }
                                className="svg__iconbox svg__icon--editBox"
                              ></span>
                                      ...
                                      return (
                                        <div className="block px-2 py-2 d-flex my-1 justify-content-between">
                                          <a
                                            ...
                                            target="_blank"
                                            data-interception="off"
                                            href={`${Items.Items.siteType}/SitePages/Portfolio-Profile.aspx?${EditData.Id}`}
                                          >
                                            {type.Title}
                                          </a>
                                          <span
                          ...
                          <ul className="p-0 mt-1">
                            <li className="form-check l-radio">
                              <input
                                ...
                                type="radio"
                                checked={
                                  EditData.Priority_x0020_Rank <= 10 &&
                                  EditData.Priority_x0020_Rank >= 8
                                }
                                onChange={() =>
                                  setEditData({
                                    ...EditData,
                                    Priority_x0020_Rank: 8,
                                  })
                                }
                              />
                            ...
                            <li className="form-check l-radio">
                              <input
                                ...
                                type="radio"
                                checked={
                                  EditData.Priority_x0020_Rank <= 7 &&
                                  EditData.Priority_x0020_Rank >= 4
                                }
                                onChange={() =>
                                  setEditData({
                                    ...EditData,
                                    Priority_x0020_Rank: 4,
                                  })
                                }
                              />
                            ...
                            <li className="form-check l-radio">
                              <input
                                ...
                                type="radio"
                                checked={
                                  EditData.Priority_x0020_Rank <= 3 &&
                                  EditData.Priority_x0020_Rank >= 0
                                }
                                onChange={() =>
                                  setEditData({
                                    ...EditData,
                                    Priority_x0020_Rank: 1,
                                  })
                                }
                              />
                          ...
                          {ComponentTaskCheck ? (
                            <div>
                              <div className="input-group">
                                ...
                                <span
                                  className="input-group-text"
                                  title="Linked Service Popup"
                                  onClick={(e) =>
                                    alert(
                                      "We Are Working On This Feature. It Will Be Live Soon..."
                                    )
                                  }
                                >
                                  <span className="svg__iconbox svg__icon--editBox"></span>
                                    ...
                                    <div className="d-flex justify-content-between">
                                      ...
                                      >
                                        <path
                                          fill-rule="evenodd"
                                          clip-rule="evenodd"
                                          d="M31.2312 14.9798C27.3953 18.8187 24.1662 21.9596 24.0553 21.9596C23.9445 21.9596 20.7598 18.8632 16.9783 15.0787C13.1967 11.2942 9.96283 8.19785 9.79199 8.19785C9.40405 8.19785 8.20673 9.41088 8.20673 9.80398C8.20673 9.96394 11.3017 13.1902 15.0844 16.9734C18.8672 20.7567 21.9621 23.9419 21.9621 24.0516C21.9621 24.1612 18.8207 27.3951 14.9812 31.2374L8 38.2237L8.90447 39.1119L9.80893 40L16.8822 32.9255L23.9556 25.851L30.9838 32.8802C34.8495 36.7464 38.1055 39.9096 38.2198 39.9096C38.4742 39.9096 39.9039 38.4689 39.9039 38.2126C39.9039 38.1111 36.7428 34.8607 32.8791 30.9897L25.8543 23.9512L32.9271 16.8731L40 9.79501L39.1029 8.8975L38.2056 8L31.2312 14.9798Z"
                                          fill="#fff"
                                        />
                                      </svg>
                                    </div>
                      ...
                      <div className="input-group">
                        ...
                        >
                          <a
                            ...
                            href={
                              EditData.component_x0020_link != null
                                ? EditData.component_x0020_link.Url
                                : ""
                            }
                            data-interception="off"
                          >
                    ...
                    {EditData.siteCompositionData != undefined &&
                      ...
                      <div className="Sitecomposition">
                        <div className="dropdown">
                          <a
                            className="sitebutton bg-fxdark"
                    ...
                    <div className="col mt-2">
                      <div className="input-group">
                        ...
                        <span
                          className="input-group-text"
                          title="Status Popup"
                          onClick={() => openTaskStatusUpdatePopup(EditData)}
                        >
                          <span
                            title="Edit Task"
                            className="svg__iconbox svg__icon--editBox"
                          ...
                          <ul className="p-0 mt-1">
                            <li className="form-check l-radio">
                              <input
                                ...
                                defaultChecked={
                                  EditData.Mileage <= 15 && EditData.Mileage > 0
                                    ? true
                                    : false
                                }
                              />
                  ...
                  <div className="col-sm-5">
                    {EditData.Title != null &&
                      ...
                      <SiteCompositionComponent
                        ...
                        isPortfolioConncted={
                          ComponentTaskCheck || ServicesTaskCheck ? true : false
                        }
                      />
                    ) : null}
                  </div>
                      ...
                      <div className="row">
                          ...
                          <div className="mx-0 row  ">
                            ...
                            <div className="col-6 ps-0 mt-2">
                              <div className="input-group ">
                                ...
                                <input
                                  type="date"
                                  className="form-control complete-Date "
                                  max="9999-12-31"
                                  min={
                                    EditData.StartDate
                                      ? Moment(EditData.StartDate).format(
                          ...
                          <div className="mx-0 row mt-2">
                            <div className="col ps-0">
                              <div className="input-group mb-2">
                                ...
                                {smartComponentData?.length > 0 ||
                                  smartServicesData?.length > 0 ? null : (
                                  <>
                                    <input
                                      type="text"
                                      className="form-control"
                                ...
                                {smartComponentData.length > 0 &&
                                  ...
                                  smartComponentData?.map((com: any) => {
                                    return (
                                      <>
                                        <div
                                          className="block d-flex justify-content-between px-2 py-1"
                                          style={{ width: "85%" }}
                                        >
                                          <a
                                            style={{ color: "#fff !important" }}
                          ...
                          <div className="col mt-2">
                            <div className="input-group">
                              ...
                              <span
                                className="input-group-text"
                                onClick={() =>
                                  openTaskStatusUpdatePopup(EditData)
                                }
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="col-md-4">
                          <div className="full_width ">
                            <CommentCard
                              siteUrl={siteUrls}
                              userDisplayName={Items.Items.userDisplayName}
      ...
      >
        <div className="hoverImageModal-popup">
          ...
          <footer
            className="justify-content-between d-flex pb-1 mx-2"
            style={{ color: "white" }}
          >
            <span className="mx-1">
              {" "}
                    ...
                    {SiteTypes?.map((siteData: any, index: number) => {
                      if (siteData.Title !== "QA") {
                        return (
                          <li
                            key={siteData.Id}
                            className={`mx-1 p-2 position-relative  text-center  mb-2 ${siteData.BtnStatus
                              ? "selectedSite"
                              : "bg-siteColor"
                              }`}
                          >
              ...
              <div className="border full-width my-2 p-2">
                {ApproverData?.map((val: any) => {
                  return (
                    <>
                      <span>
                        <a className="hreflink block p-1 px-2 mx-1">
                          {" "}
                          {val.Title}
                          <svg
