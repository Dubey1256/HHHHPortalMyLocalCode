            ...
            .then((response: AxiosResponse) => {
                ...
                DataEdit.map((item: any) => {
                    ...
                    if (item.Team_x0020_Members != undefined) {
                        let newuserdata: any = {};
                        $.each(item.Team_x0020_Members, function (index: any, newitem: any) {
                            $.each(taskUsers, function (index: any, user: any) {
                                if (newitem.Id === user.AssingedToUserId && user.Item_x0020_Cover != undefined) {
                                    newuserdata['useimageurl'] = user.Item_x0020_Cover.Url;
                                    newuserdata['Suffix'] = user.Suffix;
                        ...
                        item.TeamMember.push(newuserdata);
                    }
                                                        ...
                                                        <div className="col-md-5">
                                                            ...
                                                            <div className="mx-0 row  mb-10">
                                                                <div className="col ps-0">
                                                                 ...
                                                                 Datepicker"
                                                                        placeholder="DD/MM/YYYY" className="form-control" defaultValue={items.Created != null ? Moment(items.Created).format('DD/MM/YYYY') : ""} />
                                                                ...
                                                                <div className="col">
                                                                    ...
                                                                    <span title="Re-occurring Due Date">
                                                                        <input type="checkbox" className="form-check-input ms-2"
                                                                            ...
                                                                            ng-click="OpenDueDatePopup()" defaultValue={items.DueDate != null ? Moment(items.DueDate).format('DD/MM/YYYY') : ""} />
                                                                    </span>
                                                            ...
                                                            <div className="mx-0 row  mb-10">
                                                                <div className="col ps-0">
                                                                    ...
                                                                    <div className="input-group mb-10">
                                                                        ...
                                                                        {((items.Component == undefined && items.Component.length < 0) && (items.Services == undefined && items.Services.length < 0)) &&
                                                                            <>
                                                                        ...
                                                                        {(items.Component != undefined && items.Component.length > 0) &&
                                                                            <>
                                                                                {items.Component.map((com: any) => {
                                                                                    return (
                                                                                        <>
                                                                                            <label ng-show="Item.SharewebTaskType.Title!='Project' && Item.SharewebTaskType.Title!='Step' && Item.SharewebTaskType.Title!='MileStone'">
                                                                                            ...
                                                                                            <div className="block ng-scope">
                                                                                                <a className="hreflink ng-binding" target="_blank" href={`https://hhhhteams.sharepoint.com/sites/HHHH/SP/SitePages/Portfolio-Profile.aspx?taskId=${2373}`}>{com.Title}</a>
                                                                         ...
                                                                         {(items.Services != undefined && items.Services.length > 0) &&
                                                                            <>
                                                                                {items.Services.map((com: any) => {
                                                                                    return (
                                                                                        <>
                                                                                            <label ng-show="Item.SharewebTaskType.Title!='Project' && Item.SharewebTaskType.Title!='Step' && Item.SharewebTaskType.Title!='MileStone'">
                                                                ...
                                                                <div className="col">
                                                                    <div className="col-12 mb-10">
                                                                        ...
                                                                        <input type="text" className="form-control"
                                                                            placeholder="Priority" defaultValue={items.Priority_x0020_Rank
                                                                            }
                                                                        />
                                                                        <ul>
