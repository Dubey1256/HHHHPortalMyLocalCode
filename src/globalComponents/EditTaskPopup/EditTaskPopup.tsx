        ...
        <>
            ...
            >
                <div className="modal-body">
                    ...
                    <div className="border tab-content" id="myTabContent">
                        <div className="tab-pane show active" id="IMAGEINFORMATION" role="tabpanel" aria-labelledby="IMAGEINFORMATION">
                            <div className="single-image-section">
                                <img src={compareImageArray?.length > 0 ? compareImageArray[0].ImageUrl : ""} />
                                ...
                                <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                                    <div className="carousel-inner">
                                        {TaskImages.map((imageData: any, index: number) => {
                                            <div className={index == 0 ? "carousel-item active" : "carousel-item"}>
                                                <img src={imageData.ImageUrl} className="d-block w-100" alt="..." />
                                            </div>
                                        })}
                                    </div>
                                    <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                        ...
                        <div className="tab-pane " id="IMAGEIMESHEET" role="tabpanel" aria-labelledby="IMAGETIMESHEET">
                            <div>
                                <NewTameSheetComponent props={Items}
                                    TeamConfigDataCallBack={getTeamConfigData}
                                />
