                                                ...
                                                <div>
                                                    <Table className='table table-hover mb-0'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                   <div className="d-flex" > <span className={`svg__iconbox svg__icon--${UploadedDocDetails?.docType}`}></span><a href={UploadedDocDetails?.link} target="_blank" data-interception="off" className='hreflink'>{UploadedDocDetails?.fileName}</a>{`(${UploadedDocDetails?.size})`}</div></td>
