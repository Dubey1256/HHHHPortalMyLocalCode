...
export default function TestBackupSmartPages(props: any) {
    ...
    const uploadImages = async (page: any) => {
        ...
        try {         
            ...
            const imageData = {
                ...
                images: [
                    {
                        url: `https://hhhhteams.sharepoint.com/sites/HHHH/PublishingImages/TestImages/TestImage2.jpeg`,
                        id: `0test`,
                        fileName: `test0`,
                        mediaType: 'image',
                        metadata: {
                    ...
                    {
                        url: `https://hhhhteams.sharepoint.com/sites/HHHH/PublishingImages/TestImages/TestImage4.jpeg`,
                        id: `1test`,
                        fileName: `test1`,
                        mediaType: 'image',
                        metadata: {
