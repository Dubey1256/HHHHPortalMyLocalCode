...
const AlertManagementTable = (props: any) => {
        ...
        if (confirmation) {
          try {
            if (item.Id != undefined) {
              let web = new Web(parenturl);
              await web.lists
                .getById(props?.SelectedProp?.ColumnManagementListID)
    ...
    const savecolumn = () => {
        ...
        if (createitem) {
            ...
            web.lists.getById(props?.SelectedProp?.ColumnManagementListID).items.add(postData)
    ...
    const loaddropdown = () => {
        ...
        web.lists.getById( props?.SelectedProp?.ColumnManagementListID).fields.get()
    ...
    const LoadcolumnsNew = () => {
        ...
        web.lists.getById(props?.SelectedProp?.ColumnManagementListID).items.select('Id,Title,ItemType,ButtonTitle,InternalName,Description,Position,SortOrder,Created,Modified,Author/Name,Author/Title,Editor/Name,Editor/Title').expand('Author,Editor').filter("Id eq " + editalertmessage.Id).getAll()
    ...
    const updateTaskRecords = () => {
        ...
        globalcommon.updateItemById(parenturl, props?.SelectedProp?.ColumnManagementListID, postData, editalertmessage.Id)
    ...
    const customTableHeaderButtons = (
        ...
        {itemtype === 'Confirmation' ? <button type="button" className="btn btn-primary me-2" onClick={AddConfirmationColumn}>Add Confirmation Message</button> : <button type="button" className="btn btn-primary me-2" onClick={AddConfirmationColumn}>Add Alert Message</button>}
    </div>
)
                ...
                <div className='Alltable mt-2'>
                    <div className='smart'>
                        <div className='wrapper'>
                            <div>
                                <GlobalCommanTable columns={columns} data={alertcolumns} showHeader={true} callBackData={callBackData} hideTeamIcon={true} hideOpenNewTableIcon={true} customHeaderButtonAvailable={true} customTableHeaderButtons={customTableHeaderButtons}/>
                        ...
                        <Row className="mb-1">
                            <Col md={12} className="mb-1">
                                <div className="input-group">
                                    ...
                                    <input className="form-control" type="text" value={AddData.Title} onChange={(e) => setAddData({ ...AddData, Title: e.target.value })} />
                                </div>
                            </Col>
                            <Col>
                                <div className="input-group">
                                    <label className="form-label full-width" htmlFor="">Sort Order</label>
                                    <input className="form-control" type="text" value={AddData.SortOrder} onChange={(e) => setAddData({ ...AddData, SortOrder: e.target.value })} />
                                </div>
                            </Col>
                            <Col>
                                <div className="input-group">
                                    <label className="form-label full-width" htmlFor="">InternalName</label>
                                    <input className="form-control" type="text" value={AddData.InternalName} onChange={(e) => setAddData({ ...AddData, InternalName: e.target.value })} />
                                </div>
                            </Col>
                        </Row>
                        <Row className="mb-1">
                            <Col>
                                <div className="input-group">
                                    ...
                                    <select className="form-select" value={AddData.ItemType} onChange={(e) => setAddData({ ...AddData, ItemType: e.target.value })}>
                            ...
                            <Col>
                                <div className="input-group">
                                    ...
                                    <input className="form-control" type="text" value={AddData.ButtonTitle} onChange={(e) => setAddData({ ...AddData, ButtonTitle: e.target.value })} />
                                </div>
                            </Col>
                        </Row>
                        <Row>
                    ...
                    <ModalBody>
                        <Row className="mb-1">
                            <Col>
                                <div className="input-group ">
                                    <label className="form-label full-width" htmlFor="">Alert Title</label>
                                    <input className="form-control" type="text" value={EditData.Title} onChange={(e) => setEditData({ ...EditData, Title: e.target.value })} />
                                </div>
                            </Col>
                            <Col>
                                <div className="input-group ">
                                    <label className="form-label full-width" htmlFor="">Sort Order</label>
                                    <input className="form-control" type="text" value={EditData.SortOrder} onChange={(e) => setEditData({ ...EditData, SortOrder: e.target.value })} />
                                </div>
                            </Col>
                            {/* <Col>
                            <div className="input-group ">
                        ...
                        <Row className="mb-1">
                            <Col>
                                <div className="input-group ">
                                    ...
                                    <select className="form-select" value={EditData.ItemType} onChange={(e) => setEditData({ ...EditData, ItemType: e.target.value })} disabled>
                                        {DropdownArrayitemtype.map(function (h: any, i: any) {
                                            return (
                            ...
                            <Col>
                                <div className="input-group ">
                                    ...
                                    <input className="form-control" type="text" value={EditData.ButtonTitle} onChange={(e) => setEditData({ ...EditData, ButtonTitle: e.target.value })} />
                                </div>
                            </Col>
                        </Row>
                        <Row>
