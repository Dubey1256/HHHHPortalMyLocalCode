                ...
                return (
                  <tr style={{ textAlign: "center", padding: "8px", background: "#fff" }}>
                    ...
                    {/* <td style={{border:"1px solid #CCC",borderTop:"0px"}}>
                         ...
                         */}
                    <td style={item.eventType=="Work From Home"?{border:"1px solid #CCC",background:"#E0A209"}:item.eventType == "Un-Planned" ? { border: "1px solid #CCC", background: "#f00" } : { borderBottom: "1px solid #CCC", background: "#0ac55f", padding: "8px" }}>
                      {item.eventType}
                    </td>
