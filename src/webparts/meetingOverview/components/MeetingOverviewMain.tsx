                ...
                const fetchPromises = siteConfig.map(async (config: any) => {
                    if (config?.listId != undefined) {
                        ...
                        smartmeta = await web.lists
                            ...
                            .items
                            .select("Id,Title,Priority_x0020_Rank,ParentTask/Id,EstimatedTime,TaskID,TaskLevel,EstimatedTimeDescription,ComponentLink,workingThisWeek,EstimatedTime,SharewebTaskLevel1No,SharewebTaskLevel2No,OffshoreImageUrl,OffshoreComments,ClientTime,Sitestagging,Priority,Status,ItemRank,IsTodaysTask,Body,Component/Id,Component/Title,Services/Id,Services/Title,PercentComplete,Events/Id,ComponentId,Categories,ServicesId,EventsId,PriorityRank,Priority_x0020_Rank,DueDate,SharewebTaskType/Id,SharewebTaskType/Title,TaskType/Id,TaskType/Title,Created,Modified,SharewebCategories/Id,SharewebCategories/Title,AssignedTo/Id,AssignedTo/Title,Portfolio/Id,Portfolio/Title,Team_x0020_Members/Id,Team_x0020_Members/Title,Responsible_x0020_Team/Id,Responsible_x0020_Team/Title,component_x0020_link,TaskCategories/Title,TaskCategories/Id")
