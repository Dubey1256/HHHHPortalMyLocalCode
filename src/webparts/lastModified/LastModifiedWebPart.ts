...
import * as strings from 'LastModifiedWebPartStrings';
import LastModified from './components/LastModified';
import { ILastModifiedProps } from './components/ILastModifiedProps';
...
export default class LastModifiedWebPart extends BaseClientSideWebPart<ILastModifiedWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ILastModifiedProps> = React.createElement(
      LastModified,
      {
  ...
  private _getEnvironmentMessage(): any {
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField('EventListId', {
                  label: "EventListId"
                }),PropertyPaneTextField('NewsListId', {
                  label: "NewsListId"
                }),
