...
function TasksTable(props: any) {
  ...
  const GetSmartmetadata = async () => {
    ...
    let AllSiteName: any = [];
    var select: any = 'Id,Title,IsVisible,ParentID,SmartSuggestions,TaxType,Description1,Color_x0020_Tag,Item_x005F_x0020_Cover,listId,siteName,siteUrl,SortOrder,SmartFilters,Selectable,Parent/Id,Parent/Title&$expand=Parent'
