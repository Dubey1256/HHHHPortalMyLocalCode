...
export default class Taskprofile extends React.Component<ITaskprofileProps, ITaskprofileState> {
  ...
  private async GetResult() {
    ...
    taskDetails = await web.lists
      ...
      .select("ID","Title","DueDate","StartDate","Categories","Status","CompletedDate","Team_x0020_Members/Title","Team_x0020_Members/Id","ItemRank","PercentComplete","Priority","Created","Author/Title","Author/EMail","BasicImageInfo","component_x0020_link","FeedBack","Responsible_x0020_Team/Title","Responsible_x0020_Team/Id","SharewebTaskType/Title","ClientTime","Component/Id","Component/Title","Services/Id","Services/Title","Editor/Title","Modified","Attachments","AttachmentFiles")
