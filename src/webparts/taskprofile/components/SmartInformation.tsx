...
// import { useState, useEffect } from 'react';
  ...
  const [allValue, setallSetValue] = useState({
    Title: "", URL: "", Acronym: "", Description: "" ,InfoType:"SmartNotes",SelectedFolder:"Public"
  })
 ...
 const [showAdddocument,setshowAdddocument]=useState(false);
  ...
  const handleClose =() =>{
    ...
    setShow(false);
    seteditvalue(null);
    setallSetValue({...allValue,Title:"",URL:"",Acronym:"",Description:"",InfoType:"SmartNotes",SelectedFolder:"Public"});
...
// get smartInformationId tag in task
  const GetResult = async () => {
    ...
    let taskDetails: any = [];
    // let listInfo = await web.lists.getByTitle(props.listName).get();
  ...
  //========delete function==================
  const deletData=async(DeletItem:any)=>{
  ...
  // add document in side popup.
   const addDocument= async( items:any)=>{
    if( items=="editAddDocument"){
            ...
            <>
              <div className='dropdown'>
                <div className='bg-ee d-flex py-1 '>
                  ...
                  <a  onClick={()=>addDocument("editAddDocument")}>
      ...
      <Panel onRenderHeader={onRenderCustomHeader}
        ...
        <footer className='text-end mt-2'>
          <div className='col-sm-12 row'>
            ...
            <div><a onClick={()=>deletData(editvalue.Id)}><img  className='pe-1' src='https://hhhhteams.sharepoint.com/_layouts/images/delete.gif'/>Delete this item</a></div>
             </div>} 
             </div>
  ...
  onDismiss={handleClose}>
    <div>
    <div className="SmartNotesTaskTiles Tile-Style3 justify-center mb-10  ">
                        <a className="tile ng-scope" ng-click="SelectedTiles('UploadDocument')">
                            <span>
                                Document
                                <div className="col-sm-12">
                                    <img src="https://hhhhteams.sharepoint.com/sites/Joint/SiteCollectionImages/Tiles/Tile_LibraryBooks.png" className="d-block" title="Documents" data-themekey="#"/>
                                </div>
                            </span>
                        </a>
                        <a className="tile ng-scope" ng-click="SelectedTiles('UploadEmail')">
                            <span>
                                Email
                                <div className="col-sm-12">
                        ...
                        <a className="tile ng-scope" ng-click="SelectedTiles('CreateLink')">
                            <span>
                                Link
                                <div className="col-sm-12">
                        ...
                        <a className="tile ng-scope" ng-click="SelectedTiles('Task')">
                            <span>
                                Task
                                <div className="col-sm-12">
                        ...
                        <a className="tile ng-scope ng-hide" ng-show="CurrentSiteUrl=='GmBH'" ng-click="SelectedTiles('Contact')">
                            <span>
                                Contact
                                <div className="col-sm-12">
