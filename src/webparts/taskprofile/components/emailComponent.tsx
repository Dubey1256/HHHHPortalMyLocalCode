                        ...
                        props.items["FeedBack"][0]?.FeedBackDescriptions?.map((fbData: any, i: any) => {
                          return <>
                            <tr >
                              ...
                              <td
                                style={(fbData?.isShowLight == "Reject") ? ({ background: "rgba(255, 0, 0, 0.09)", border: "1px solid #ccc", padding: "0px 2px 0px 10px" }) : (fbData?.isShowLight == "Approve") ? ({ background: "#00800024", border: "1px solid #ccc", padding: "0px 2px 0px 10px" }) : ({ background: "#fbfbfb", border: "1px solid #ccc", padding: "0px 2px 0px 10px" })}
