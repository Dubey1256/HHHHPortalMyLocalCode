                            ...
                            <>
                                ...
                                <div className="TableSection"><div className="Alltable">
                                    <div className='wrapper'>
                                        ...
                                        {selectedView == 'Projects' ? <GlobalCommanTable expandIcon={true}  ref={childRef} callChildFunction={callChildFunction} restructurebtn={true} restructureCallBack={callBackData1}  AllListId={AllListId} headerOptions={headerOptions} paginatedTable={false} multiSelect={true} columns={column2} data={flatData} callBackData={callBackData} pageName={"ProjectOverview"} pageProjectOverview={true} TaskUsers={AllTaskUser} showHeader={true} /> : ''}
                                    </div>
                                </div>
                                </div>
