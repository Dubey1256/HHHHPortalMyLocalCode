...
import * as strings from 'SiteStructureWebPartStrings';
import SiteStructure from './components/SiteStructure';
import { ISiteStructureProps } from './components/ISiteStructureProps';
...
export default class SiteStructureWebPart extends BaseClientSideWebPart<ISiteStructureWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISiteStructureProps> = React.createElement(
      SiteStructure,
      {
