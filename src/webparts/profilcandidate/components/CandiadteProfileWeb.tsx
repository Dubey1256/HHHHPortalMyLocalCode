...
const Profilcandidate = ({props}: any) => {
    ...
    const EmployeeDetails = async (Id: any) => {
        try {
            await web.lists.getById('298bc01c-710d-400e-bf48-8604d297c3c')
    ...
    return (
        <myContextValue.Provider value={{ ...myContextValue, allSite: allSite, allListId: allListId, loggedInUserName: props?.userDisplayName }}>
            {isEditPopupOpen ? <EditPopup siteUrl={'https://hhhhteams.sharepoint.com/sites/HHHH/HR/'} EditPopupClose={EditPopupClose} callbackEdit={callbackEdit} item={selectedItem} ListID={'298bc01c-710d-400e-bf48-8604d297c3c'} skillsList={'e79dfd6d-18aa-40e2-8d6e-930a37fe54e4'}/> : ''}
