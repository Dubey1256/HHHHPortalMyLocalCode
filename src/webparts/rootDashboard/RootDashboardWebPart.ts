...
import * as strings from 'RootDashboardWebPartStrings';
import RootDashboard from './components/RootDashboard';
import { IRootDashboardProps } from './components/IRootDashboardProps';

export interface IRootDashboardWebPartProps {
  description: string;
...
export default class RootDashboardWebPart extends BaseClientSideWebPart<IRootDashboardWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IRootDashboardProps> = React.createElement(
      RootDashboard,
      {
