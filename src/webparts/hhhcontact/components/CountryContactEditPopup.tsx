...
const CountryContactEditPopup = (props: any) => {
    ...
    const onRenderCustomHeadersmartinfo = () => {
        return (
            <>
                <h3>
                    Select {props.popupName}    <span className="ml-auto"> <Tooltip ComponentId='1626' /></span>
                </h3>
    ...
    const CustomFootersmartinfo=()=>{
        return(
            ...
            <Button className='btn btn-primary ms-1 mx-2' onClick={() => props.callBack(updateData)}>
                Save
            </Button>
                        ...
                        <div className="list-group mx-2 my-2 d-flex" style={{ width: "18rem" }}>
                            {props?.popupName == 'Country' && updateData?.SmartCountries?.length>0 ?
                                <li className="list-group-item list-group-item-action d-flex justify-content-between" style={{ background: "#000066", color: "#fff" }} >
                                    ...
                                    <span style={{ cursor: 'pointer' }} onClick={() => updateData({ ...updateData, SmartCountries: [] })}><img src='https://grueneweltweit.sharepoint.com/_layouts/images/delete.gif' />
                                    </span>
                                </li>
                                : null}
                            ...
                            {props?.popupName == 'State' && selectedStateData!= undefined ?
                                <li className="list-group-item list-group-item-action d-flex justify-content-between" style={{ background: "#000066", color: "#fff" }} >
                                    ...
                                    <span style={{ cursor: 'pointer' }} onClick={() => updateData({ ...updateData,Fedral_State : '' })}><img src='https://grueneweltweit.sharepoint.com/_layouts/images/delete.gif' />
                                    </span>
                                </li>
                                : null}
                        </div>
