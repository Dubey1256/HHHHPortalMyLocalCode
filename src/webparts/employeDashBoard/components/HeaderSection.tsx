  ...
  return (
    <div>
      <section className="NameTopSec">
        <div className="d-flex shadow-sm p-3 mb-3 bg-white rounded">
          ...
          <div className="col alignCenter justify-content-end">
            ...
            <WorldClock />
            <img className="rounded-circle" width={"30px"} height={"30px"} src={userName?.Item_x0020_Cover?.Url} />
          </div>
        </div>
      </section>
      <section className='annocumentSec'>
        <div className="alignCenter p-2 mb-3 rounded empBg">
          <span className="svg__iconbox svg__icon--annocument light me-2"></span>
          {
      ...
      <section className="tabSec">
        <div className="d-flex justify-content-center">
          <div
            className={`${activeTile === 'workingToday' ? 'col alignCenter me-3 mb-3 hreflink  p-3 rounded empBg shadow-sm active empBg' : 'col alignCenter me-3 p-3 bg-white mb-3 hreflink  rounded shadow-sm'}`}
          ...
          <div
            className={`${activeTile === 'workingThisWeek' ? 'col alignCenter me-3 mb-3 hreflink  p-3 rounded empBg shadow-sm active empBg' : 'col alignCenter me-3 p-3 bg-white hreflink  mb-3 rounded shadow-sm'}`}
          ...
          <div
            className={`${activeTile === 'bottleneck' ? 'col alignCenter me-3 hreflink  mb-3 p-3 rounded empBg shadow-sm active empBg' : 'col alignCenter me-3 p-3 bg-white hreflink  mb-3 rounded shadow-sm'}`}
          ...
          <div
            className={`${activeTile === 'immediate' ? 'col alignCenter me-3 hreflink mb-3 p-3 rounded empBg shadow-sm active empBg' : 'col alignCenter me-3 p-3 bg-white hreflink mb-3 rounded shadow-sm'}`}
          ...
          <div
            className={`${activeTile === 'draft' ? 'col alignCenter me-3 hreflink  mb-3 p-3 rounded empBg shadow-sm active empBg' : 'col alignCenter me-3 p-3 hreflink  bg-white mb-3 rounded shadow-sm'}`}
