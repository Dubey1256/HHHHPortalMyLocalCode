...
import GroupByComponentsDashboard from './components/GroupByComponentsDashboard';
import { IGroupByComponentsDashboardProps } from './components/IGroupByComponentsDashboardProps';
...
export default class GroupByComponentsDashboardWebPart extends BaseClientSideWebPart<IGroupByComponentsDashboardWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGroupByComponentsDashboardProps> = React.createElement(
