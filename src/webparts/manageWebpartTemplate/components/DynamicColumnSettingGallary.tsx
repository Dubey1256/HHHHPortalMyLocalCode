...
import ColumnSettingSortingPannel from "../../../globalComponents/GroupByReactTableComponents/columnSettingSortingPannel";
const DynamicColumnSettingGallary = (props: any) => {
    ...
    const handleChangeDateAndDataCallBack = async () => {
        if (props?.smartFabBasedColumnsSettingToggle != true) {
            ...
            props?.columnSettingCallBack(preSetColumnSettingVisibility);
        }
    };
...
export default DynamicColumnSettingGallary;
