...
const MeetingProfile = (props: any) => {
  ...
  const [editpopupData, setEditPopupData] = React.useState({
    isEditModalOpen: false, isModalOpen: false, imageInfo: {}, isCalloutVisible: false, replyTextComment: "", currentDataIndex: null, showPopup: 'none', CommenttoUpdate: "", isEditReplyModalOpen: false,
    updateCommentText: {
      'comment': '',
