...
const FullMailModal = (props: any) => {
    ...
    const filterModalData = fullData.map((item: any) => item);
        ...
        <>
            <Modal
                ...
                <div className={contentStyles.body}>
                    <p><strong>From:</strong> {showingData?.senderEmail}</p>
                    <p><strong>Sent on:</strong> {showingData?.creationTime}</p>
                    <p><strong>To:</strong> {showingData?.recipients}</p>
                    <p style={{lineHeight: 2}}><strong>Subject:</strong> {showingData?.Title}</p>
