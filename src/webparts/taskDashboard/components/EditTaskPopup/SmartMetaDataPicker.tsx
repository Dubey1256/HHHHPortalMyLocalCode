...
const Picker=()=>{
    ...
    return(
        <>
         <img title="Edit Details" className="wid22" src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/Foundation/EMMCopyTerm.png"
                                                                                        onClick={()=>openPopupSmartTaxanomy()} />
                                                                                        {/* <button type="button" className="brn btn-primary" onClick={()=>openPopupSmartTaxanomy()}>Picker</button> */}
        <Modal
