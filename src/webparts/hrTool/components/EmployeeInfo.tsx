                                                                                ...
                                                                                <div className="infoblock aboutus col-sm-12 form-group clearfix  ">
                                                                                    ...
                                                                                    <div className='PersonalInformation'>
                                                                                        <div className=" infoblock contact d-flex padL-0">
                                                                                            ...
                                                                                            <div className="col-lg-9 labeltext">{HrData.dateOfBirth != null ? moment(HrData.dateOfBirth).format('DD/MM/YYYY') : ""}</div>
                                                                                        </div>
                                                                                        <div className=" infoblock contact d-flex  ">
                                                ...
                                                ContractData.map((contract: any, index: any) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td>{contract.startDate != null ? moment(contract.startDate).format('DD/MM/YYYY') : ""}</td>
                                                            <td>{contract.endDate != null ? moment(contract.endDate).format('DD/MM/YYYY') : ""}</td>
