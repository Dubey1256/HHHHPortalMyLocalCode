                                        ...
                                        <table className="SalarySliptable" cellPadding="0" cellSpacing="0" width="100%" ref={componentRef}>
                                            <tbody>
                                                <tr>
                                                    <th align="left">
                                                        <h5>
                                                            <strong>Payroll: </strong><span ng-bind="GetColumnDetails(Item.Month)"> {Item.Month}</span>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 PadR0 ItemInfo-right">
                                <div className="pull-right">
                                    ...
                                    />
                                    <Button type="button" variant="primary" className='FooterBtn'>Print</Button>
                                    <Button type="button" variant="secondary" className='FooterBtn'>Cancel</Button>
                                </div>
                            </div>
                        </div>
                    </div>
