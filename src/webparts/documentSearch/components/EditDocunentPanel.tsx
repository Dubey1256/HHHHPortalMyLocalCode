...
const EditDocumentpanel = (props: any) => {
  ...
  const updateDocumentsData = async () => {
    ...
    if (allValue.componentservicesetdata.smartComponent != undefined) {
      //componetServicetagData = allValue.componentservicesetdata.smartComponent;
    }
    if (allValue.componentservicesetdata.linkedComponent != undefined) {
      //  componetServicetagData = allValue.componentservicesetdata.linkedComponent;
    }
    ...
    <>
      ...
      >
        ...
        <footer className='bg-f4 fixed-bottom'>
          <div className='d-flex justify-content-between align-items-center pt-1 px-4'>
