...
const ImagetabFunction = (props: any) => {
    const [editData, setEditData] = useState(props.EditSmartMetaData)
    ...
    const UploadImageValue = (e: any, selectTab: any) => {
        ...
        reader.onload = () => {
            ...
            setUploadedImage(uploadedImages);
        }
                            ...
                            <Nav variant="pills" className="flex-column">
                                ...
                                <div className='mt-3 mx-0'>
                                    ...
                                    <ul className='alignCenter list-none'>
                                        <li>
                                            <span><a href={`${props.EditSmartMetaData.EncodedAbsUrl}?web=1`} target="_blank" data-interception="off">
                                                {props.EditSmartMetaData?.File_x0020_Type == "pdf" && <span className='alignIcon  svg__iconbox svg__icon--pdf' title="pdf"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "docx" && <span className='alignIcon  svg__iconbox svg__icon--docx' title="docx"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "csv" || props.EditSmartMetaData?.File_x0020_Type == "xlsx" && <span className='svg__iconbox svg__icon--csv' title="csv"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "jpeg" || props.EditSmartMetaData?.File_x0020_Type == "jpg " && <span className='svg__iconbox svg__icon--jpeg' title="jpeg"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "ppt" || props.EditSmartMetaData?.File_x0020_Type == "pptx" && <span className='svg__iconbox svg__icon--ppt' title="ppt"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "svg" && <span className='alignIcon  svg__iconbox svg__icon--svg' title="svg"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "zip" && <span className='alignIcon  svg__iconbox svg__icon--zip' title="zip"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "png" && <span className='alignIcon  svg__iconbox svg__icon--png' title="png"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "txt" && <span className='alignIcon  svg__iconbox svg__icon--txt' title="txt"></span>}
                                                {props.EditSmartMetaData?.File_x0020_Type == "smg" && <span className='alignIcon  svg__iconbox svg__icon--smg' title="smg"></span>}
                                                {props.EditSmartMetaData.Url != null && <span className='alignIcon  svg__iconbox svg__icon--link' title="smg"></span>}
                                            </a>Open this Document</span>
                                        </li>
                                    </ul>
                                    {/* <span> <a href={`${props.EditSmartMetaData.EncodedAbsUrl}?web=1`}>Open this Document</a></span> */}
                                </div>
                                        ...
                                        <Tab eventKey="copy & paste" title="copy & paste" className='p-0'>
                                            <div className='border border-top-0  p-2'>
                                                <div className="input-group "><label className=" full-width ">Image Name</label>
                                                    <input type="text" className="form-control" value={props?.EditSmartMetaData?.Title} placeholder='image Name' />
                                                </div>
                                                <div className='mt-3'>
