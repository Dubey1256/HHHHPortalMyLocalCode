...
export default class LastModifiedItemsApp extends React.Component<ILastModifiedItemsAppProps, ILastModifiedItemsAppState> {
    ...
    private async loadConfigurations() {
        ...
        if (resSmartMetadata.length) {
            ...
            selNavItem.columns = "ParentTask/Title,ParentTask/Id,Services/Title,ClientTime,Services/Id,Events/Id,Events/Title,ItemRank,Portfolio_x0020_Type,SiteCompositionSettings,TaskLevel,TaskLevel,TimeSpent,BasicImageInfo,OffshoreComments,OffshoreImageUrl,CompletedDate,TaskID,ResponsibleTeam/Id,ResponsibleTeam/Title,TaskCategories/Id,TaskCategories/Title,ParentTask/TaskID,TaskType/Id,TaskType/Title,TaskType/Level,TaskType/Prefix,PriorityRank,Reference_x0020_Item_x0020_Json,TeamMembers/Title,TeamMembers/Name,Component/Id,Component/Title,Component/ItemType,TeamMembers/Id,Item_x002d_Image,ComponentLink,IsTodaysTask,AssignedTo/Title,AssignedTo/Name,AssignedTo/Id,AttachmentFiles/FileName,FileLeafRef,FeedBack,Title,Id,PercentComplete,Company,StartDate,DueDate,Comments,Categories,Status,WebpartId,Body,Mileage,PercentComplete,Attachments,Priority,Created,Modified,Author/Id,Author/Title,Editor/Id,Editor/Title,RelevantTasks/Id,RelevantTasks/Title&$expand=RelevantTasks,ParentTask,Events,Services,TaskType,AssignedTo,Component,AttachmentFiles,Author,Editor,TeamMembers,ResponsibleTeam,TaskCategories&$orderby=Modified desc&$top=200";
    ...
    private async getLastModifiedItems() {
        ...
        if (selTabName == "DOCUMENTS") {
            ...
            listLastModifiedItems = resListItems.map(resListItem => ({
                ...
                Priority: resListItem.PriorityRank ? parseInt(resListItem.PriorityRank) : 0,
                Modified: {
                    Date: this.formatDate(resListItem.Modified),
                    UserName: resListItem.Editor.Title,
                    ...this.getUserInfo(resListItem.Editor.Id)
            ...
            allTabItems.forEach(async (tabItem, tabIndex) => {
                ...
                if (_resListItems.length) {
                    resListItems = _resListItems.map(resListItem => ({
                        ...
                        ComponentLink: resListItem.ComponentLink ? resListItem.ComponentLink.Url : "#",
                        DueDate: this.formatDate(resListItem.DueDate),
                        PercentComplete: resListItem.PercentComplete ? parseFloat(resListItem.PercentComplete) * 100 : 0,
                        Priority: resListItem.PriorityRank ? parseInt(resListItem.PriorityRank) : 0,
                        TeamUsers: this.getTeamUsers(resListItem.ResponsibleTeam, resListItem.AssignedTo, resListItem.TeamMembers),
                        Modified: {
                            Date: this.formatDate(resListItem.Modified),
                            UserName: resListItem.Editor.Title,
                            ...this.getUserInfo(resListItem.Editor.Id)
                ...
                <div className="justify-content-between tbl-headings">
                    ...
                    <span className="toolbox">
                        ...
                        {this.state.selNavItem?.tabName == "DOCUMENTS" || this.state.selNavItem?.tabName == "FOLDERS" || this.state.selNavItem?.tabName == "COMPONENTS" || this.state.selNavItem?.tabName == "SERVICES" ?
                            ...
                            "" : <Checkbox checked={this.state.componentsChecked} onChange={this.onComponentsChecked} label="Components" className=" me-2" />
...

                        {
                            ...
                            this.state.selNavItem?.tabName == "DOCUMENTS" || this.state.selNavItem?.tabName == "FOLDERS" || this.state.selNavItem?.tabName == "COMPONENTS" || this.state.selNavItem?.tabName == "SERVICES" ?
                                ...
                                "" :  <Checkbox checked={this.state.serviceChecked} onChange={this.onServiceChecked} label="Service" />
